...
func (a *EntitiesApiService) CreateEntity(ctx context.Context, contentType string, body CreateEntityRequest, localVarOptionals *CreateEntityOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListEntitiesOpts - Optional Parameters:
...
func (a *EntitiesApiService) ListEntities(ctx context.Context, localVarOptionals *ListEntitiesOpts) ([]ListEntitiesResponse, *http.Response, error) {
	var (
 ...
 * @param optional nil or *RemoveEntityOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Entity type, to avoid ambiguity in case there are several entities with the same entity id.


*/

type RemoveEntityOpts struct { 
	Type_ optional.String
}

func (a *EntitiesApiService) RemoveEntity(ctx context.Context, entityId string, localVarOptionals *RemoveEntityOpts) (*http.Response, error) {
	var (
 ...
 * @param contentType 
 * @param body 
 * @param optional nil or *ReplaceAllEntityAttributesOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Entity type, to avoid ambiguity in case there are several entities with the same entity id.
...
type ReplaceAllEntityAttributesOpts struct { 
	Type_ optional.String
	Options optional.String
}

func (a *EntitiesApiService) ReplaceAllEntityAttributes(ctx context.Context, entityId string, contentType string, body ReplaceAllEntityAttributesRequest, localVarOptionals *ReplaceAllEntityAttributesOpts) (*http.Response, error) {
	var (
 ...
 * @param optional nil or *RetrieveEntityOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Entity type, to avoid ambiguity in case there are several entities with the same entity id.
...
type RetrieveEntityOpts struct { 
	Type_ optional.String
	Attrs optional.String
	Metadata optional.String
	Options optional.String
...
func (a *EntitiesApiService) RetrieveEntity(ctx context.Context, entityId string, localVarOptionals *RetrieveEntityOpts) (RetrieveEntityResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entityId Id of the entity to be retrieved
 * @param optional nil or *RetrieveEntityAttributesOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Entity type, to avoid ambiguity in case there are several entities with the same entity id.
...
type RetrieveEntityAttributesOpts struct { 
	Type_ optional.String
	Attrs optional.String
	Metadata optional.String
	Options optional.String
...
func (a *EntitiesApiService) RetrieveEntityAttributes(ctx context.Context, entityId string, localVarOptionals *RetrieveEntityAttributesOpts) (RetrieveEntityAttributesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param contentType 
 * @param body 
 * @param optional nil or *UpdateExistingEntityAttributesOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Entity type, to avoid ambiguity in case there are several entities with the same entity id.
     * @param "Options" (optional.String) -  Operations options
...
type UpdateExistingEntityAttributesOpts struct { 
	Type_ optional.String
	Options optional.String
}

func (a *EntitiesApiService) UpdateExistingEntityAttributes(ctx context.Context, entityId string, contentType string, body UpdateExistingEntityAttributesRequest, localVarOptionals *UpdateExistingEntityAttributesOpts) (*http.Response, error) {
	var (
 ...
 * @param contentType 
 * @param body 
 * @param optional nil or *UpdateOrAppendEntityAttributesOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Entity type, to avoid ambiguity in case there are several entities with the same entity id.
     * @param "Options" (optional.String) -  Operations options
...
type UpdateOrAppendEntityAttributesOpts struct { 
	Type_ optional.String
	Options optional.String
}

func (a *EntitiesApiService) UpdateOrAppendEntityAttributes(ctx context.Context, entityId string, contentType string, body UpdateOrAppendEntityAttributesRequest, localVarOptionals *UpdateOrAppendEntityAttributesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
