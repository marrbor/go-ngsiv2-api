 ...
 * @param optional nil or *ListEntityTypesOpts - Optional Parameters:
...
type ListEntityTypesOpts struct { 
	Limit optional.Float64
	Offset optional.Float64
	Options optional.String
}

func (a *TypesApiService) ListEntityTypes(ctx context.Context, localVarOptionals *ListEntityTypesOpts) ([]ListEntityTypesResponse, *http.Response, error) {
	var (
