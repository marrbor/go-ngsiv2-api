 ...
 * @param contentType 
 * @param body 
 * @param optional nil or *NotifyOpts - Optional Parameters:
...
func (a *BatchOperationsApiService) Notify(ctx context.Context, contentType string, body NotifyRequest, localVarOptionals *NotifyOpts) (*http.Response, error) {
	var (
...
func (a *BatchOperationsApiService) Query(ctx context.Context, contentType string, body QueryRequest, localVarOptionals *QueryOpts) ([]QueryResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *BatchOperationsApiService) Update(ctx context.Context, contentType string, body UpdateRequest, localVarOptionals *UpdateOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
