...
type APIEntryPointApiService service

/* 
APIEntryPointApiService Retrieve API Resources
...
*/
func (a *APIEntryPointApiService) RetrieveAPIResources(ctx context.Context) (RetrieveApiResourcesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RetrieveApiResourcesResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RetrieveApiResourcesResponse
