...
*/
func (a *SubscriptionsApiService) CreateSubscription(ctx context.Context, contentType string, body CreateSubscriptionRequest) (*http.Response, error) {
	var (
...
func (a *SubscriptionsApiService) ListSubscriptions(ctx context.Context, localVarOptionals *ListSubscriptionsOpts) ([]ListSubscriptionsResponse, *http.Response, error) {
	var (
...
*/
func (a *SubscriptionsApiService) UpdateSubscription(ctx context.Context, subscriptionId string, contentType string, body UpdateSubscriptionRequest) (*http.Response, error) {
	var (
